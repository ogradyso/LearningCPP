...
//
//template <typename T>
//std::ostream& operator<<(std::ostream& outputStream, T theBrake) {
//	outputStream << theBrake.get_collision_threshold_s()<<theBrake.get_speed_mps()<<std::endl;
//	return outputStream;
//}
//
//int main() {
//	MockServiceBus thebus{};
//	AutoBrake brakeTime{thebus};
//	std::cout << brakeTime;
//
//}
